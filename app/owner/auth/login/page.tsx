    ...
    return (
        <main className="min-h-screen bg-brand-cloud flex flex-col">
            <header className="p-6 flex items-center">
                ...
                <h1 className="text-2xl font-bold text-brand-slate">Fleet Owner Portal</h1>
            </header>
                ...
                >
                    <div className="bg-white rounded-3xl p-8 shadow-xl">
                        <div className="text-center mb-8">
                            ...
                            <p className="text-brand-grey">Manage your fleet with ease</p>
                        </div>
                        ...
                        <form onSubmit={handleSubmit} className="space-y-6">
                            ...
                            <div className="space-y-2">
                                <label className="block text-sm font-medium text-brand-slate mb-2">Password</label>
                                <div className="relative">
                                    <input
                                        ...
                                        className="w-full px-4 py-4 bg-brand-cloud border border-gray-200 rounded-xl text-brand-slate placeholder-brand-grey focus:outline-none focus:ring-2 focus:ring-brand-blue/50 focus:border-brand-blue/50 transition-all pr-12"
                                    />
                                    <button
                                        type="button"
                                        onClick={() => setShowPassword(!showPassword)}
                                        className="absolute right-4 top-1/2 -translate-y-1/2 text-brand-grey hover:text-brand-slate transition-colors"
                                    >
                                        {showPassword ? (
                        ...
                        <div className="mt-8 pt-6 border-t border-gray-100 text-center">
                            ...
                            <Link href="/owner/auth/signup">
                                <Button
                                    variant="outline"
                                    className="w-full py-5 border-2 border-brand-blue text-brand-blue hover:bg-brand-blue/5 transition-all duration-300"
                                >
